...
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, JavaDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | JavaDayData): ChartEntry => ({
