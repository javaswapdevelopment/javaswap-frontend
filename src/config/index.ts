...
export const POLYGON_BLOCK_TIME = 2.5
...
export const JAVA_PER_BLOCK = new BigNumber(0.00001)
...
export const BASE_POLYGON_SCAN_URL = BASE_POLYGON_SCAN_URLS[ChainId.MAINNET]
