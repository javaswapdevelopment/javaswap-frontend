...
import { Currency, Token } from '@javaswap/sdk'
import { Button, Text, Modal, useModal, InjectedModalProps, Link } from '@javaswap/uikit'
          ...
          return (
            ...
            Object.keys(unsupportedTokens).includes(token.address) && (
              <AutoColumn key={token.address?.concat('not-supported')} gap="10px">
                ...
                {chainId && (
                  <Link external small color="primaryDark" href={getPolygonScanLink(token.address, 'address', chainId)}>
                    {token.address}
                  </Link>
                )}
              </AutoColumn>
