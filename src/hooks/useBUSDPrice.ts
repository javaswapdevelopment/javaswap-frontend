...
export const useJavaBusdPrice = (): Price | undefined => {
  const javaBusdPrice = useBUSDPrice(tokens.java)
  return javaBusdPrice
}

export const useMATICBusdPrice = (): Price | undefined => {
  const maticBusdPrice = useBUSDPrice(tokens.wmatic)
  return maticBusdPrice
}
