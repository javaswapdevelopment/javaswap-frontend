        ...
        <>
          ...
          <Flex flexDirection="column">
            ...
            <Flex justifyContent="space-between" flexDirection={['column', 'column', 'column', 'row']}>
              ...
              <Flex>
                <a
                  href={`https://javaswap.io/add/${poolData.token0.address}/${poolData.token1.address}`}
                >
                ...
                <a
                  href={`https://javaswap.io/swap?inputCurrency=${poolData.token0.address}&outputCurrency=${poolData.token1.address}`}
                >
