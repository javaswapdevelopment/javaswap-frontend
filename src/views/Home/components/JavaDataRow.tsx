  ...
  return (
    <Grid>
      <Flex flexDirection="column">
        ...
        {javaSupply ? (
          <Balance decimals={0} lineHeight="1.1" fontSize="24px" bold value={javaSupply} />
        ) : (
      ...
      <StyledColumn>
        ...
        <Heading scale="lg">{t('%javaEmissions%/block', { javaEmissions: emissionsPerBlock })}</Heading>
      </StyledColumn>
    </Grid>
  )
}

export default JavaDataRow
