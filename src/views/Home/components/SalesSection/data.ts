...
export const swapSectionData: SalesSectionProps = {
  ...
  secondaryButton: {
    to: 'https://javaswap.gitbook.io/javaswap/',
    text: 'Learn',
    external: true,
  },
  images: {
...
export const earnSectionData: SalesSectionProps = {
  ...
  secondaryButton: {
    to: 'https://javaswap.gitbook.io/javaswap/products/yield-farming',
    text: 'Learn',
    external: true,
  },
  images: {
...
export const javaSectionData: SalesSectionProps = {
  ...
  secondaryButton: {
    to: 'https://javaswap.gitbook.io/javaswap/tokenomics/java',
    text: 'Learn',
    external: true,
  },
