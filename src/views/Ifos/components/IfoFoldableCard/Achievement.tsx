...
import { Flex, LinkExternal, Image, Text, PrizeIcon, Skeleton } from '@javaswap/uikit'
  ...
  return (
    <Container>
      ...
      <Flex alignItems="flex-end" flexDirection="column">
        ...
        <StyledLinkExternal href={getPolygonScanLink(ifo.address, 'address')}>{t('View Contract')}</StyledLinkExternal>
      </Flex>
    </Container>
  )
}
