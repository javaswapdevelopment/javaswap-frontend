...
A brief overview how Info part of JavaSwap website works.
...
`prices` - gets MATIC prices (current, 24h, 48 and 7d ago) used in calculations (see [src/hooks/useMaticPrices.ts](../src/hooks/useMaticPrices.ts))
